    ...
    <el-row :gutter="24">
      ...
      <el-col :xs="24" :sm="24" :lg="12">
        <div class="chart-wrapper">
          ...
          <el-form ref="addBrand" :model="addBrand" :inline="true" label-width="90px"
        ...
        <div class="chart-wrapper">
          ...
          <el-form ref="delBrand" :model="delBrand" :inline="true" label-width="90px"
                   style="width: 420px; margin-left:50px;"
          >
            <el-form-item label="品牌名称" required>
              <el-select v-model="delBrand.brandId" class="filter-item" placeholder="请选择">
                <el-option v-for="item in brandOptions" :key="item.brandId" :label="item.brandName"
                           :value="item.brandId"
                />
              </el-select>
            </el-form-item>
        ...
        <div class="chart-wrapper">
          ...
          <el-form ref="addSeries" :model="addSeries" :inline="true" label-width="90px"
                   style="width: 420px; margin-left:50px;"
          >
        ...
        <div class="chart-wrapper">
          ...
          <el-form ref="delSeries" :model="delSeries" :inline="true" label-width="100px"
                   style="width: 420px; margin-left:50px;"
          >
